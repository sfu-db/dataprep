...
- Collect data from common data sources (through :ref:`userguide/connector`)
- Do your exploratory data analysis (through :ref:`userguide/eda`)
- Clean and standardize data (through :ref:`userguide/clean`)
...
.. table:: 
    ...
    +=============+=====================================================================+=====================================================================+
    | PyPI        | .. image:: https://img.shields.io/pypi/v/dataprep?style=flat-square | .. image:: https://pepy.tech/badge/dataprep                         |
    |             |     :target: https://pypi.org/project/dataprep/                     |     :target: https://pepy.tech/project/dataprep                     |
    +-------------+---------------------------------------------------------------------+---------------------------------------------------------------------+
    | conda-forge | .. image:: https://img.shields.io/conda/vn/conda-forge/dataprep.svg | .. image:: https://img.shields.io/conda/dn/conda-forge/dataprep.svg |
    |             |     :target: https://anaconda.org/conda-forge/dataprep              |     :target: https://anaconda.org/conda-forge/dataprep              |
    +-------------+---------------------------------------------------------------------+---------------------------------------------------------------------+
