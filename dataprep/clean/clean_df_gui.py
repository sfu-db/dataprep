...
#from ipywidgets.widgets import Label, Dropdown, Checkbox, Button, HBox, VBox, Box, Layout, Text, HTML, Output
...
from dataprep.clean.gui3.clean_gui import launch
...
class UserInterface:
    ...
    def display(self):
        ...
        #return HTML(filename=current_path + "/dataprep/clean/gui/index.html")
