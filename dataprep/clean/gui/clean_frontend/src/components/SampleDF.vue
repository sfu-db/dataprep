<template>
  <el-container>
    <el-header><Header  @newDataYes = "updateTableData"  @updateFooterLog="reloadFooterLog"  @getTheTrueFile="updateTableData"  /></el-header>
    <el-main>
      <el-row class="el-main-params">
          <el-col :span="6"><Cleanning  @optionsValue="changeCleanning"  @parashow="paraShowChange" /></el-col>
          <el-col :span="16" :offset="1" class="el-main-1st-row-2ndcol">
            <CleanWholeDF v-show="parashow"  @updateFooterLog = "reloadFooterLog"  @newDataYes = "updateTableData" v-bind:filenname="filenname"/>
            <CleanFunctions v-show="singColoumShow"
      ...
      <el-row class="el-main-1st-row">
          <el-col :span="24" ><MainTable :key="timer2"  v-bind:filenname="filenname" /></el-col>
      </el-row>
    </el-main>
...
//import Cleanning from '@/components/Cleanning'
//import MainTable from '@/components/MainTable'
//import FooterLog from '@/components/FooterLog'
//import SingColoum from '@/components/SingColoum'
//import CleanEmail from '@/components/CleanEmail'
