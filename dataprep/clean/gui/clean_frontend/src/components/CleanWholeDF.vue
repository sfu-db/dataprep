<template>
    <el-row>
        ...
        <el-col :span="3"  >
            <el-button  icon="el-icon-circle-check" class="el-col-select-box-button" @click="clickOK"><br>OK!</el-button>
        </el-col>
    </el-row>
</template>
<script>
...
export default ({
  ...
  methods:{
    clickOK(){
      ...
      axios
        .post("http://localhost:7680/cleanWholeDF", param, config)
        .then(function(res){
          console.log(res)
