...
def boxplot(dataframe: pd.DataFrame, col_x: str, col_y: str) -> Dict[str, dict]:
...
def stackedplot(dataframe: pd.DataFrame, col_x: str, col_y: str) -> Dict[tuple, int]:
...
def scatterplot(dataframe: pd.DataFrame, col_x: str, col_y: str) -> Dict[Union[int, float], Union[int, float]]:
    """ 
